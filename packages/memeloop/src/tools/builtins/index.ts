...
export function registerBuiltinTools(registry: IToolRegistry, context: BuiltinToolContext): void {
  ...
  registry.registerTool(getMcpClientToolId(), (arguments_: Record<string, unknown>) =>
    mcpClientImpl(arguments_, context),
  );
  registry.registerTool(getMcpForwardToolId(), (arguments_: Record<string, unknown>) =>
    mcpForwardImpl(arguments_, context),
  );
  registry.registerTool(getSpawnAgentToolId(), (arguments_: Record<string, unknown>) =>
    spawnAgentImpl(arguments_, context),
  );
  registry.registerTool(getRemoteAgentToolId(), (arguments_: Record<string, unknown>) =>
    remoteAgentImpl(arguments_, context),
  );
  registry.registerTool(ASK_QUESTION_TOOL_ID, (arguments_: Record<string, unknown>) =>
    askQuestionImpl(arguments_, context),
  );
  registry.registerTool(TODO_WRITE_TOOL_ID, (arguments_: Record<string, unknown>) =>
    todoWriteImpl(arguments_, context),
  );
  registry.registerTool(ASK_USER_QUESTION_TOOL_ID, (arguments_: Record<string, unknown>) =>
    askUserQuestionImpl(arguments_, context),
  );
  registry.registerTool(getTaskToolId(), (arguments_: Record<string, unknown>) =>
    taskToolImpl(arguments_, context),
  );
