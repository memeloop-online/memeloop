...
**Remaining debt (2026-07-23):** item 1 (a runnable, published container image/entrypoint) remains. The generic 24.61 conformance harness still needs an external-orchestrator suite; current coverage is the dedicated external contract/controller tests plus the K8s/Swarm fake-server suites.
